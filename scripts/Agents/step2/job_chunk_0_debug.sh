...
#SBATCH --output=Agents/step2/results/debug.out
...
python ../agent.py \
  ...
  --num_iterations 11 \
  --library_path ../data/library/library_step2/library_debug.json \
  --vector_store_path ../data/library/vector_store_step_copy \
